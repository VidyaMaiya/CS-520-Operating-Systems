...
public class SJF {
	...
	public void processCreation()
	{
	  ...
	  System.out.println("Process "+process1.processNumber+"'s burst time (in ms) "+process1.processBurstTime);

	  
	  process2 = new ProcessControlBlock(2, "start",((ran.nextDouble()*(4-2))+2)*60000, 35, 0,eTime); 
	  System.out.println("Process "+process2.processNumber+"'s burst time (in ms) "+process2.processBurstTime);

	  
	  process3 = new ProcessControlBlock(3, "start",((ran.nextDouble()*(4-2))+2)*60000, 40, 0,eTime); 
	  System.out.println("Process "+process3.processNumber+"'s burst time (in ms) "+process3.processBurstTime);

	  
	  process4 = new ProcessControlBlock(4, "start",((ran.nextDouble()*(4-2))+2)*60000, 45, 0,eTime); 
	  System.out.println("Process "+process4.processNumber+"'s burst time (in ms) "+process4.processBurstTime);

	  
	  process5 = new ProcessControlBlock(5, "start",((ran.nextDouble()*(4-2))+2)*60000, 50, 0,eTime); 
	  System.out.println("Process "+process5.processNumber+"'s burst time (in ms) "+process5.processBurstTime);

	  
	  process6 = new ProcessControlBlock(6, "start",((ran.nextDouble()*(4-2))+2)*60000, 55, 0,eTime); 
	  System.out.println("Process "+process6.processNumber+"'s burst time (in ms) "+process6.processBurstTime);

	  
	  process7 = new ProcessControlBlock(7, "start",((ran.nextDouble()*(4-2))+2)*60000, 60, 0,eTime); 
	  System.out.println("Process "+process7.processNumber+"'s burst time (in ms) "+process7.processBurstTime);

	  
	  process8 = new ProcessControlBlock(8, "start",((ran.nextDouble()*(4-2))+2)*60000, 65, 0,eTime);
	  System.out.println("Process "+process8.processNumber+"'s burst time (in ms) "+process8.processBurstTime);
	  
	  process9 = new ProcessControlBlock(9, "start",((ran.nextDouble()*(4-2))+2)*60000, 70, 0,eTime);
	  System.out.println("Process "+process9.processNumber+"'s burst time (in ms) "+process9.processBurstTime);
	  
	  process10 = new ProcessControlBlock(10, "start",((ran.nextDouble()*(4-2))+2)*60000, 75, 0,eTime);
	  System.out.println("Process "+process10.processNumber+"'s burst time (in ms) "+process10.processBurstTime);
	...
	{
		EventStructure event1 = new EventStructure(process1, cpu_enque, eTime,"sjf");
		EventStructure.generateEvent(event1);
	
		EventStructure event2 = new EventStructure(process2, cpu_enque, eTime,"sjf");
		EventStructure.generateEvent(event2);
		
		EventStructure event3 = new EventStructure(process3, cpu_enque, eTime,"sjf");
		EventStructure.generateEvent(event3);

		EventStructure event4 = new EventStructure(process4, cpu_enque, eTime,"sjf");
		EventStructure.generateEvent(event4);
		
		EventStructure event5 = new EventStructure(process5, cpu_enque, eTime,"sjf");
		EventStructure.generateEvent(event5);
		
		EventStructure event6 = new EventStructure(process6, cpu_enque, eTime,"sjf");
		EventStructure.generateEvent(event6);
		
		EventStructure event7 = new EventStructure(process7, cpu_enque, eTime,"sjf");
		EventStructure.generateEvent(event7);
		
		EventStructure event8 = new EventStructure(process8, cpu_enque, eTime,"sjf");
		EventStructure.generateEvent(event8);
		
		EventStructure event9 = new EventStructure(process9, cpu_enque, eTime,"sjf");
		EventStructure.generateEvent(event9);
		
		EventStructure event10 = new EventStructure(process10, cpu_enque, eTime,"sjf");
