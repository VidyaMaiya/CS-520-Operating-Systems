...
public class RoundRobin extends ReadyQueue{
	...
	{
		EventStructure event1 = new EventStructure(process1, cpu_enque, eTime,"rr");
		EventStructure.generateEvent(event1);
	
		EventStructure event2 = new EventStructure(process2, cpu_enque, eTime,"rr");
		EventStructure.generateEvent(event2);
			
		EventStructure event3 = new EventStructure(process3, cpu_enque, eTime,"rr");
		EventStructure.generateEvent(event3);

		EventStructure event4 = new EventStructure(process4, cpu_enque, eTime,"rr");
		EventStructure.generateEvent(event4);
			
		EventStructure event5 = new EventStructure(process5, cpu_enque, eTime,"rr");
		EventStructure.generateEvent(event5);
			
		EventStructure event6 = new EventStructure(process6, cpu_enque, eTime,"rr");
		EventStructure.generateEvent(event6);
			
		EventStructure event7 = new EventStructure(process7, cpu_enque, eTime,"rr");
		EventStructure.generateEvent(event7);
			
		EventStructure event8 = new EventStructure(process8, cpu_enque, eTime,"rr");
		EventStructure.generateEvent(event8);
			
		EventStructure event9 = new EventStructure(process9, cpu_enque, eTime,"rr");
		EventStructure.generateEvent(event9);
			
		EventStructure event10 = new EventStructure(process10, cpu_enque, eTime,"rr");
